 ...
 * BASIC_AUTH_USER / BASIC_AUTH_PASSWORD (recommended for a real secret, since
 * the repo is public).
 *
 * NOTE: keep this file in sync with the repo-root copy
 * (netlify/edge-functions/basic-auth.ts) — duplicated so the gate works whether
 * the Netlify "base directory" is apps/web or the repo root.
 */
